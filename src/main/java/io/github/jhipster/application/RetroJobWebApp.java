...
public class RetroJobWebApp {

    private static final Logger log = LoggerFactory.getLogger(RetroJobWebApp.class);

    private final Environment env;

    public RetroJobWebApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes RetroJobWeb.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RetroJobWebApp.class);
